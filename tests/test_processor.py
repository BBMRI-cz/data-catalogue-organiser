...
FAKE_ALL_RUNS_FOR_COPY = os.path.join(
    os.path.dirname(__file__), "test_pseudonymized_runs"
)
...
FAKE_OLD_MISEQ_PATH = os.path.join(
    FAKE_ALL_RUNS_FOR_COPY, "200101_M00000_0000_00000000-00000"
)
FAKE_NEW_MISEQ_PATH = os.path.join(
    FAKE_ALL_RUNS_FOR_COPY, "240101_M00000_0000_00000000-00000"
)
FAKE_NEXTSEQ_PATH = os.path.join(
    FAKE_ALL_RUNS_FOR_COPY, "230101_N0000000_0000_0000000000"
)

FAKE_OLD_MISEQ_FOR_TESTING = os.path.join(
    FAKE_ALL_RUNS_FOR_TESTING, "200101_M00000_0000_00000000-00000"
)
FAKE_NEW_MISEQ_FOR_TESTING = os.path.join(
    FAKE_ALL_RUNS_FOR_TESTING, "240101_M00000_0000_00000000-00000"
)

FAKE_NEXTSEQ_FOR_TESTING = os.path.join(
    FAKE_ALL_RUNS_FOR_TESTING, "230101_N0000000_0000_0000000000"
)
...
def mocked_old_miseq_organise_run(mocker):
    return mocker.patch(
        "organiser.run_organisers.old_miseq_organise_run.OldMiseqRunOrganiser.organise_run"
    )
...
def mocked_new_miseq_organise_run(mocker):
    return mocker.patch(
        "organiser.run_organisers.new_miseq_organise_run.NewMiseqRunOrganiser.organise_run"
    )
...
def mocked_nextseq_organise_run(mocker):
    return mocker.patch(
        "organiser.run_organisers.nextseq_organise_run.NextSeqRunOrganiser.organise_run"
    )


def test_select_old_miseq(
    setup_and_teardown_old_miseq,
    ...
    processor = Processor(
        FAKE_ALL_RUNS_FOR_TESTING, FAKE_DESTINATION_FILES, FAKE_PATIENT_FILES, tmp_path
    )
...
def test_select_new_miseq(
    setup_and_teardown_new_miseq,
    mocked_new_miseq_organise_run,
    mocked_old_miseq_organise_run,
    mocked_nextseq_organise_run,
    tmp_path,
...
def test_new_and_old_miseq_called(
    setup_and_teardown_new_miseq,
    setup_and_teardown_old_miseq,
    mocked_new_miseq_organise_run,
    mocked_old_miseq_organise_run,
...
def test_select_nextseq(
    setup_and_teardown_nextseq,
    mocked_nextseq_organise_run,
    mocked_old_miseq_organise_run,
    mocked_new_miseq_organise_run,
    tmp_path,
