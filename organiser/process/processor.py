...
class Processor:
    def __init__(
        self,
        pseudnymized_runs_folder,
        folder_for_organised_files,
        patient_folder,
        log_dir,
    ):
    ...
    def _try_organise_run(self, run, organiser) -> bool:
        ...
        try:
            ...
            shutil.move(
                os.path.join(self.psedunymized_runs_folder, run),
    ...
    def _create_important_folders_if_not_exist(self):
        create_dictionary_if_not_exist(
            os.path.join(self.organised_files_folder, "logs")
        )
        create_dictionary_if_not_exist(
            os.path.join(self.organised_files_folder, "backups")
        )
        create_dictionary_if_not_exist(
            os.path.join(self.organised_files_folder, "errors")
        )
